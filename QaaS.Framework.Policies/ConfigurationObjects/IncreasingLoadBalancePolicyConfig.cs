...
public class IncreasingLoadBalancePolicyConfig : IPolicyConfig
{
    [
        ...
        Description(
            $"The initial amount of actions to perform every {nameof(TimeIntervalMs)} milliseconds"
        )
    ]
    ...
    [
        ...
        Range(1, ulong.MaxValue),
        Description(
            $"The maximum amount of actions to perform every {nameof(TimeIntervalMs)} milliseconds"
        )
    ]
    ...
    [
        Range(1, ulong.MaxValue),
        Description($"How much to increase the rate every {nameof(RateIncreaseIntervalMs)}"),
        DefaultValue(1)
    ]
    ...
    [
        ...
        Description($"How often to increase the rate by {nameof(RateIncrease)} in milliseconds"),
        DefaultValue(1000)
    ]
    ...
    [
        Range(1, ulong.MaxValue),
        Description("The time in milliseconds to perform `Rate` actions in"),
        DefaultValue(1000)
    ]
