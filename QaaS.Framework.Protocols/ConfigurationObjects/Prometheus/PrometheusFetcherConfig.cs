...
public record PrometheusFetcherConfig : IFetcherConfig
{
    ...
    [
        Required,
        Description("The expression to query the prometheus query_range API with to collect data")
    ]
    ...
    [
        Range(1, uint.MaxValue),
        Description(
            "The timeout in milliseconds for the execution of the query sent to the prometheus API"
        ),
