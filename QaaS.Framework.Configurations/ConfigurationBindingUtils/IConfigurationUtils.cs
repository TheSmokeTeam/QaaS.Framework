...
public static class IConfigurationUtils
{
    ...
    public static IConfiguration BindConfigurationObjectToIConfiguration(
        this IConfiguration configuration,
        object? configurationObject
    ) => configuration.MergeConfigurationObjectIntoIConfiguration(configurationObject);
