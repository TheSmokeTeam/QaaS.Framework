...
{
    public RequiredIfAnyAttribute(string stringConditions)
        : base(stringConditions) { }

    public RequiredIfAnyAttribute(string fieldName, params object?[] possibleFieldValues)
        : base(fieldName, possibleFieldValues) { }

    public RequiredIfAnyAttribute(
        string[] stringConditionsFields,
        params object[] stringConditionsValues
    )
        : base(stringConditionsFields, stringConditionsValues) { }
