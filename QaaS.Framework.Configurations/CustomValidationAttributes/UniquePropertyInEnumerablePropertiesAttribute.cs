...
public class UniquePropertyInEnumerablePropertiesAttribute : ValidationAttribute
{
    ...
    public UniquePropertyInEnumerablePropertiesAttribute(
        string fieldName,
        string validationErrorMeaningMessage,
        params string[] enumerablePropertiesNames
    )
    {
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        foreach (var item in enumerableValue)
        {
            ...
            if (itemValidationResult != ValidationResult.Success)
