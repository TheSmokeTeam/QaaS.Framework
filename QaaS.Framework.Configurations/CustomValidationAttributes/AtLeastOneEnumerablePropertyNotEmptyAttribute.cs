...
public class AtLeastOneEnumerablePropertyNotEmptyAttribute : ValidationAttribute
{
    ...
    public AtLeastOneEnumerablePropertyNotEmptyAttribute(
        params string[] enumerablePropertyNamesToCheckArray
    )
    {
    ...
    protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
    {
        ...
        var allObjectEnumerableProperties = valueType
            .GetProperties(
                BindingFlags.Public
        ...
        var specificEnumerablePropertiesToCheck = allObjectEnumerableProperties
            .Where(property => _enumerablePropertyNamesToCheck.Contains(property.Name))
            .ToArray();

        return specificEnumerablePropertiesToCheck.Any(property =>
            property.GetValue(value) is IEnumerable enumerable && enumerable.Cast<object?>().Any()
        )
            ? ValidationResult.Success
            : new ValidationResult(
