...
{
    public NullIfAnyAttribute(string stringConditions)
        : base(stringConditions) { }

    public NullIfAnyAttribute(string fieldName, params object?[] possibleFieldValues)
        : base(fieldName, possibleFieldValues) { }

    public NullIfAnyAttribute(
