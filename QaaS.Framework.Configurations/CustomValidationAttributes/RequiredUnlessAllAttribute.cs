...
/// <summary>
/// Validates that the property has value unless all given conditions are met by the other properties in the object
/// Basically the property is required unless all conditions are true.
...
/// </summary>
public class RequiredUnlessAllAttribute: ValidationAttribute
{
    private readonly List<KeyValuePair<string, object?>> _conditions;
        
    /// <summary>
    /// Constructs the conditional required attribute with a string representing the conditions
    /// </summary>
    ...
    ///  </param>
    public RequiredUnlessAllAttribute(string stringConditions)
    {
    ...
    /// <summary>
    /// Constructs the conditional required attribute with 2 string arrays representing the conditions
    /// </summary>
    ...
    /// </param>
    public RequiredUnlessAllAttribute(string[] stringConditionsFields, params object[] objectConditionsValues)
    {
