...
public class ConfigurationInternalHelpersCoverageTests
{
    ...
    private static readonly Type MergeUtilsType = typeof(ConfigurationUtils).Assembly.GetType(
        "QaaS.Framework.Configurations.ConfigurationBindingUtils.ConfigurationMergeUtils",
        true
    )!;
    private static readonly Type DictionaryUtilsType = typeof(ConfigurationUtils).Assembly.GetType(
        "QaaS.Framework.Configurations.ConfigurationBindingUtils.DictionaryUtils",
        true
    )!;

    private static MethodInfo GetMergeMethod(string methodName) =>
        MergeUtilsType.GetMethod(methodName, BindingFlags.Static | BindingFlags.NonPublic)!;

    private static object? InvokeMerge(string methodName, params object?[] args) =>
        GetMergeMethod(methodName).Invoke(null, args);

    private static object? InvokeDictionaryUtils(string methodName, params object?[] args) =>
        DictionaryUtilsType
            .GetMethod(
                methodName,
    ...
    public void MergeUtility_PrivateMergeBranches_HandleDictionariesListsNullAndScalars()
    {
        ...
        var preservedList = (IList)
            InvokeMerge("MergeValues", new List<object?> { 1, 2 }, new List<object?>())!;
        var replacedList = (IList)
            InvokeMerge("MergeValues", new List<object?> { 1 }, new List<object?> { 3, 4 })!;
    ...
    public void MergeUtility_PrivateConversionAndSkipBranches_HandleConfigurationsCollectionsAndObjects()
    {
        var config = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?> { ["nested:value"] = "1" })
            .Build();
        var container = new SampleContainer
        {
            Config = config,
            Map = new Hashtable { ["alpha"] = "one" },
        ...
        var patchConfig =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertPatchValue", typeof(IConfiguration), config)!;
        var patchDictionary =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertPatchValue", typeof(Hashtable), container.Map)!;
        var patchList =
            (List<object?>)
                InvokeMerge("ConvertPatchValue", typeof(List<object?>), container.Items)!;
        var patchClass =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertPatchValue", typeof(SampleChild), container.Child)!;

        var currentConfig =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertCurrentValue", typeof(IConfiguration), config)!;
        var currentDictionary =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertCurrentValue", typeof(Hashtable), container.Map)!;
        var currentList =
            (List<object?>)
                InvokeMerge("ConvertCurrentValue", typeof(List<object?>), container.Items)!;
        var currentClass =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertCurrentValue", typeof(SampleChild), container.Child)!;

        var shouldSkipConfig = (bool)
            InvokeMerge("ShouldSkipPatchValue", typeof(IConfiguration), config, config)!;
        var shouldSkipDictionary = (bool)
            InvokeMerge("ShouldSkipPatchValue", typeof(Hashtable), container.Map, container.Map)!;
        var shouldSkipList = (bool)
            InvokeMerge(
                "ShouldSkipPatchValue",
                typeof(List<object?>),
                container.Items,
                container.Items
            )!;
        var shouldSkipClass = (bool)
            InvokeMerge(
                "ShouldSkipPatchValue",
                typeof(SampleChild),
                container.Child,
        ...
        var shouldSkipNull = (bool)
            InvokeMerge("ShouldSkipPatchValue", typeof(string), null, "value")!;
        var shouldSkipScalar = (bool)
            InvokeMerge("ShouldSkipPatchValue", typeof(MergeMode), MergeMode.One, MergeMode.One)!;
        var shouldNotSkipScalar = (bool)
            InvokeMerge("ShouldSkipPatchValue", typeof(MergeMode), MergeMode.One, MergeMode.Two)!;
    ...
    public void MergeUtility_PublicAndPrivateHelpers_CoverNullPatchesAndNestedEnumerableBranches()
    {
        ...
        var currentDictionary =
            (Dictionary<string, object?>)
                InvokeMerge("ConvertCurrentDictionary", new Hashtable { ["value"] = null })!;
        var currentList =
            (List<object?>)InvokeMerge("ConvertCurrentList", new ArrayList { null, "text" })!;
        ...
        var equivalentDictionaryMismatch = (bool)
            InvokeMerge(
                "AreEquivalentValues",
                new Dictionary<string, object?> { ["left"] = 1 },
                new Dictionary<string, object?> { ["left"] = 2 }
            )!;
        var equivalentListMismatch = (bool)
            InvokeMerge(
                "AreEquivalentValues",
                new List<object?> { 1, 2 },
                new List<object?> { 1, 3 }
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                convertedDictionary["nested-class"],
    ...
    {
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?> { ["child:value"] = "config" })
            .Build();
        var flattenedDictionary =
            (IDictionary<string, string?>)
                InvokeDictionaryUtils(
                    "GetInMemoryCollectionFromDictionary",
                    new Dictionary<string, object?>
                    {
                        ["scalar"] = "value",
                        ["config"] = configuration,
                        ["map"] = new Hashtable { ["nested"] = "dictionary" },
                        ["list"] = new ArrayList
                        {
                            "first",
                            new Hashtable { ["inner"] = "second" },
                            new SampleChild { Name = "child" },
                        },
                    },
        ...
        InvokeDictionaryUtils(
            "GetInMemoryCollectionFromList",
            new ArrayList
            {
                null,
                configuration,
                new Hashtable { ["inner"] = "dictionary" },
        ...
        var stringDictionary =
            (Dictionary<string, object?>)
                InvokeDictionaryUtils(
                    ...
                    new Hashtable { ["answer"] = 42, [" "] = "ignored" }
                )!;
    ...
    public void DictionaryUtility_BindToDictionaryIConfiguration_CollapsesCaseInsensitiveDuplicatePaths()
    {
        var configuration = (IConfiguration)
            InvokeDictionaryUtils(
                ...
                new Dictionary<string, object?>
                {
                    ["Metadata"] = new Dictionary<string, object?> { ["Team"] = "existing-team" },
                    ["MetaData"] = new Dictionary<string, object?> { ["Team"] = "updated-team" },
                }
            )!;
    ...
    public void ConfigurationUtils_PrivateBindingHelpers_HandleListsDictionariesAndConfigurations()
    {
        ...
        object? InvokeUtils(string methodName, params object?[] args) =>
            configurationUtilsType
                .GetMethod(methodName, BindingFlags.Static | BindingFlags.NonPublic)!
                .Invoke(null, args);

        var boundDictionary = (IDictionary)
            InvokeUtils(
                "BindDictionaryTypeProperty",
        ...
        var invalidKeyException = Assert.Throws<TargetInvocationException>(() =>
            InvokeUtils(
                "BindDictionaryTypeProperty",
        ...
        var dictionaryFromList = (IDictionary)
            InvokeUtils(
                "ConvertObjectValueToType",
                new List<object?> { "a", "b" },
                binderOptions,
        ...
        var configurationFromScalar = (IConfiguration)
            InvokeUtils(
                "ConvertObjectValueToType",
                7,
                binderOptions,
        ...
        var configurationFromList = (IConfiguration)
            InvokeUtils(
                "ConvertObjectValueToType",
                new List<object?> { "x" },
                binderOptions,
        ...
        var boundUnsupportedInterfaceException = Assert.Throws<TargetInvocationException>(() =>
            InvokeUtils(
                "BindToObject",
                typeof(IDisposable),
                new Dictionary<string, object?>(),
        ...
        var invalidEnumList = (IList)
            InvokeUtils(
                "CreateListFromTypeAndConvertConfigurationListToIt",
        ...
        var indexedDictionary = (IDictionary)
            InvokeUtils(
                "ConvertConfigurationListToDictionaryWithIndexesAsKeys",
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                configurationFromList.AsEnumerable().Any(pair => pair.Value == "x"),
                Is.True
            );
            Assert.That(
                boundUnsupportedInterfaceException.InnerException,
    ...
    public void ConfigurationUtils_PublicBranches_HandleNullObjectsEmptyKeysAndInterfaceBindingFailures()
    {
        ...
        var nullScalarCollection = ConfigurationUtils.GetInMemoryCollectionFromObject(
            new NullableScalarHolder()
        );
        var reboundDictionary = (IDictionary)
            InvokeUtils(
                "BindToObject",
                typeof(Dictionary<int, string>),
                new Dictionary<string, object?>
                {
                    [string.Empty] = new List<object?> { "left", "right" },
                },
                binderOptions,
                logger,
                ":root"
            )!;
        var nullInt = InvokeUtils(
            "ConvertObjectValueToType",
            null,
            binderOptions,
            typeof(int),
        ...
        var publicBindException = Assert.Throws<ArgumentException>(() =>
            new ConfigurationBuilder()
                .Build()
                .BindToObject(typeof(IDisposable), binderOptions, logger)
        );
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                nullScalarCollection.ContainsKey(nameof(NullableScalarHolder.Maybe)),
                Is.True
            );
    ...
    public void MergeUtility_AdditionalBranches_HandleDefaultlessTypesAndEquivalenceEdgeCases()
    {
        ...
        var patchDictionary =
            (Dictionary<string, object?>)
                InvokeMerge("GetPatchDictionary", new NoDefaultCtorSample("v"))!;
        ...
        var convertedDictionary =
            (Dictionary<string, object?>)
                InvokeMerge(
                    ...
                    {
                        ["config"] = config,
                        ["nested-dictionary"] = new Hashtable { ["inner"] = "value" },
                    }
                )!;
        var convertedList =
            (List<object?>)
                InvokeMerge(
                    ...
                    {
                        config,
                        new Hashtable { ["inner"] = "value" },
                    }
                )!;
        var skipConfigAgainstDictionary = (bool)
            InvokeMerge(
                "ShouldSkipPatchValue",
                typeof(IConfiguration),
                config,
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                convertedDictionary["config"],
                Is.InstanceOf<Dictionary<string, object?>>()
            );
            Assert.That(
                convertedDictionary["nested-dictionary"],
                Is.InstanceOf<Dictionary<string, object?>>()
            );
